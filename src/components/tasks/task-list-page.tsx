...
const variantShells = {
  'listing-directory': 'bg-background',
  'listing-showcase': 'bg-background',
  'article-editorial': 'bg-background',
  'article-journal': 'bg-background',
  'image-masonry': 'bg-background',
  'image-portfolio': 'bg-background',
  'profile-creator': 'bg-background',
  'profile-business': 'bg-background',
  'classified-bulletin': 'bg-background',
  'classified-market': 'bg-background',
  'sbm-curation': 'bg-background',
  'sbm-library': 'bg-background',
} as const
