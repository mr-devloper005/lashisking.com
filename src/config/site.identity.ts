export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'lashisking',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Lash Is King',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'lashisking.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://lashisking.com',
